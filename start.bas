 ...
 1020 print "enjoy these games, read the games, and later create your own games."
 1022 print ""
 ...
 1050 print "            eat 15 green tokens without hitting anything else."
 1060 print ""
 ...
 1100 print "            is necessary, since otherwise each game would be the same."
 1110 print ""
 1120 print chr$(150)+"escape from onion cake: this is a text adventure. the story will be told"
 1130 print "            at the beginning of the game. the graphics load slowly, but you can"
 1140 print "            proceed the game also if the graphics has not loaded completely."
 ...
 1180 print ""
 1190 print chr$(158)+"now choose a game or (q)uit and load the game directly: "
 1200 print "(a) mega snake, (b) mega break, (c) escape from onion cake (press a,b,c or q)"
 ...
 3050 if a$="c" then print chr$(147)+"loading escape from onion cake":load"escapefromoc",8
